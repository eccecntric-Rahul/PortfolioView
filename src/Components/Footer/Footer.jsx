        ...
        <div className="footer">
            <div className="footer_content_container">
                <div className="footer_row">
                    <p className="icon_container"><a href="https://www.facebook.com/profile.php?id=100009120165927" target='_blank' className="footer_icon footer_icon_right_margin"><FaFacebookF  /></a>
                        <a href="https://www.instagram.com/rahul_kr_._/" target='_blank' className="footer_icon footer_icon_right_margin"><FaInstagram  /></a> 
                       <a href="https://twitter.com/RahulKu51580399" target='_blank' className="footer_icon footer_icon_right_margin"> <FaTwitter  /></a>
                       <a href="https://www.snapchat.com/add/iam-rahulkr?share_id=cxxfsAKcUuU&locale=en-US" target='_blank' className="footer_icon"> <FaSnapchatGhost  /></a>
                    </p>
                ...
                <div className="footer_row">
                <p className="icon_container" ></p>
                <p className="footer_text_container"><a href="https://google.com" target='_blank' className="footer_text_link">Wanna hire me ?</a></p>
                </div>
            </div>
